...
mc_post_beta_L <- beta_dist_param(mc_post_mean, mc_post_sd^2)
beta_post_mc_L <- dbeta(x, mc_post_beta_L$alpha, mc_post_beta_L$beta)
...
kc11_post_sd_L <- bp_sc_jags_kienzle_McMax_L$BUGSoutput$sd$kc11

norm_post_kc_L <- dnorm(xnorm, kc11_post_mean, kc11_post_sd)
