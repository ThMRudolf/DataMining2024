...
get_amps_at_freq <- function(iq, freq_lim)
{
    fft_iq <- fft(iq)
    ...
    top_indices[1] <- order(magnitude[index_rot], decreasing = TRUE)[1] +   index_rot[1] # Indices of the top 1 amplitudes
    top_indices[2] <- order(magnitude[index_cut], decreasing = TRUE)[1] + index_cut[1]
