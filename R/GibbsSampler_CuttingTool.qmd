...
std_sc_jags_kienzle_McMax <- jags(data_mill_scsc, inits, parameters, model.file="jags_kienzle_McMaxL.txt", 
...
std_sc_jags_kienzle_McMax <- jags(data_mill_scsc inits, parameters, model.file="jags_kienzle_McMaxLL.txt", 
                      n.iter=5000, n.chains=20, n.burnin=1000)
```
...
\[1\] Oppenheim, A. V., & Schafer, R. W. (2009). Discrete-Time Signal Processing (3rd ed.). Prentice-Hall. Karris, S. (2011) \[2\] Jags.model: https://library.fiveable.me/key-terms/bayesian-statistics/jagsmodel, last checked 01.12.2024
